...
use minicircuit::{
    commands::{
        ...
        command::Command,
        dll::config::GetDLLConfig,
        error::{clear_errors::ClearErrors, status::GetStatus},
        information::{identity::GetIdentity, uptime::GetUptime},
        manual::auto_gain::SetAutoGainState,
        response::Response,
        soa::config::{GetSOAConfig, SetSOAConfig},
        system::system_reset::ResetSystem,
    },
    drivers::{
...
async fn test_command_responses() {
    ...
    // let command = Command::SetSOAConfig(SetSOAConfig::default());
