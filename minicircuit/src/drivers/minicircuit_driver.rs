...
use super::{
    communication::{write_read, ReadWriteError},
    connection::autodetect_sg_port,
    ...
    match command {
        ...
        Command::GetPhase(get_phase) => {
            ...
            let command_response: Response = match write_read(port, command) {
                ...
                Err(e) => {
                    let error_response =
                        ReadWriteError::new(Command::GetPhase(get_phase), e.kind, e.description);
        ...
        Command::SetPhase(set_phase) => {
            ...
            let command_response: Response = match write_read(port, command) {
                ...
                Err(e) => {
                    let error_response =
                        ReadWriteError::new(Command::SetPhase(set_phase), e.kind, e.description);
        ...
        Command::GetPATemp(get_patemp) => {
            ...
            let command_response: Response = match write_read(port, command) {
                ...
                Err(e) => {
                    let error_response =
                        ReadWriteError::new(Command::GetPATemp(get_patemp), e.kind, e.description);
        ...
        Command::GetStatus(get_status) => {
            ...
            let command_response: Response = match write_read(port, command) {
                ...
                Err(e) => {
                    let error_response =
                        ReadWriteError::new(Command::GetStatus(get_status), e.kind, e.description);
        ...
        Command::GetUptime(get_uptime) => {
            ...
            let command_response: Response = match write_read(port, command) {
                ...
                Err(e) => {
                    let error_response =
                        ReadWriteError::new(Command::GetUptime(get_uptime), e.kind, e.description);
